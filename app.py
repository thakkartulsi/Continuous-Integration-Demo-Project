...
This is a Streamlit app that fetches a random inspirational quote from the Quotable API
and displays it to the user. The user can click a button to retrieve a new quote.
"""
